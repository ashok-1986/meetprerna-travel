...
- **Token:** `--font-marund`
- **Substitutes:** Fraunces, Newsreader, or DM Serif Display
...
- **Substitutes:** Inter, system-ui, or Geist
...
| Element | Value | Token |
|---------|-------|-------|
| tags | 6px | `--radius-tags` |
| cards | 16px | `--radius-cards` |
| images | 6px | `--radius-images` |
| inputs | 6px | `--radius-inputs` |
| buttons | 6px | `--radius-buttons` |
| navPill | 12px | `--radius-navpill` |
| largeCards | 24px | `--radius-largecards` |
| smallCards | 12px | `--radius-smallcards` |
...
| Name | Value | Token |
|------|-------|-------|
| md | `rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px` | `--shadow-md` |
| subtle | `oklch(0 0 0 / 0.3) 0px 0px 2px 0px inset, oklch(0 0 0 / 0.1) 0px 1px 0px 0px inset` | `--shadow-subtle` |
| subtle-2 | `oklch(0.439 0 0) 0px 0px 0px 0px` | `--shadow-subtle-2` |
| subtle-3 | `oklch(0.439 0 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px` | `--shadow-subtle-3` |
| subtle-4 | `oklch(0.556 0 0) 0px 0px 0px 0px` | `--shadow-subtle-4` |
| subtle-5 | `oklch(0.145 0 0) 0px 0px 0px 0px, oklab(0.999994 0.0000455678 0.0000200868 / 0.4) 0px 1px 3px 0px, oklab(0.999994 0.0000455678 0.0000200868 / 0.5) 0px 0px 4px 0px, oklab(0 0 0 / 0.3) 0px 0px 2px 0px inset, oklab(0 0 0 / 0.1) 0px 1px 0px 0px inset` | `--shadow-subtle-5` |
...
- **Surface:** White (#ffffff) on #fafafa canvas
- **Border-radius:** 16px
- **Shadow:** `rgba(0,0,0,0.1) 0px 10px 15px -3px, rgba(0,0,0,0.1) 0px 4px 6px -4px`
- **Image:** Fills card with 6px corner radius
- **Tilt:** ±2–4° optional
...
- **Border:** 1px in #e5e5e5 or #f5f5f5
- **Shadow:** Same 10-15-3 / 4-6-4 stack at reduced opacity
- **Header:** Small colored status dot (green #00c950 or amber) + model/attribution label in Inter 12px medium
- **Image area:** Below header at 6px radius
- **Connection markers:** Small 8px green node markers at card edges
...
- **Border:** 1px in #e5e5e5 or #f5f5f5
- **Shadow:** Subtle
- **Position:** Floats centered at top
- **Padding:** Horizontal 24–32px
- **Contents:** Logo icon (left), nav links (Inter 14px weight 500 #0a0a0a), Login text link, outlined CTA button
- **Height:** ~48–56px

### Primary CTA — Filled Lavender
**Role:** Main call-to-action button (hero and primary conversions)

- **Background:** #d7defd (Lavender Mist)
- **Text:** #0a0a0a (Near Black)
- **Border-radius:** 6px
- **Padding:** 8px 20px
- **Font:** Inter 14px weight 500
- **Hero treatment:** Optional 1.5px outer ring in #a6a5fe at 2px offset
- **Icon:** Arrow after label in #0a0a0a

### Secondary CTA — Outlined Violet
**Role:** Navigation and secondary action button

- **Background:** Transparent
- **Border:** 1.5px in #a6a5fe (Soft Violet)
- **Text:** #0a0a0a
- **Border-radius:** 6px
- **Padding:** 6px 16px
- **Font:** Inter 14px weight 500
- **Icon:** Arrow after label
- **Hover:** Border deepens to #4f39f6, bg becomes #d7defd at 30% opacity
...
- **Color:** #0a0a0a or #4f39f6 for chromatic links
- **Underline:** Appears on hover only, 1px, #4f39f6

### Announcement Banner
**Role:** Top utility bar above main nav for product announcements

- **Surface:** Light (#f5f5f5 or #fafafa with subtle border-bottom in #e5e5e5)
- **Font:** Inter 12px weight 400
- **Text color:** #525252
- **Contents:** Icon + message + 'Learn More >' link in #4f39f6
- **Dimensions:** Full-width, 32–40px height
...
- **Color:** #737373
- **Container:** Subtle pill (#f5f5f5 bg, 6px radius) with optional hairline border #e5e5e5
- **Usage:** 'Used by folks at', 'The best models for the job' section markers

### Display Headline
**Role:** Hero and section-level heading

- **Font:** Marund weight 500–600
- **Sizes:** 48–96px
- **Line-height:** 1.0–1.1
- **Letter-spacing:** -0.025em to -0.05em
- **Color:** #0a0a0a
- **Alignment:** Centered for hero, left-aligned for content sections
...
- **Size:** 16–18px
- **Line-height:** 1.5
- **Color:** #737373 or #525252
- **Alignment:** Centered for hero, left-aligned for content
- **Max lines:** 2 for hero subtitles

### Logo Cloud Row
**Role:** Social proof bar showing partner/brand logos

- **Style:** Grayscale logos in single horizontal row, centered
- **Logo color:** #737373 or #828282
- **Height:** 20–24px
- **Gap:** 48–80px horizontal
- **Rows:** One or two
- **Rule:** No logos in brand colors — all sit at same muted neutral

### Connection Line
**Role:** Curved SVG path connecting workspace canvas cards in product showcase

- **Stroke:** #432dd7 (Electric Violet) at 1–1.5px width
- **Opacity:** 0.4–0.6
- **Path:** Curved (Bezier) between card node markers
- **Endpoints:** Optional small filled circles, 6–8px diameter

### Status Node Marker
**Role:** Small indicator dot on canvas cards showing live/connected state

- **Size:** 6–8px filled circle
- **Color:** #00c950 (Signal Green)
- **Detail:** Optional 1px white inner ring for separation
- **Position:** Card edges or near content headers

### Embedded Chat Block
**Role:** AI-generated content card embedded in workspace canvas

- **Surface:** White card with 1px #e5e5e5 border, 12px radius
- **Header:** Small colored dot (model indicator) + model name in Inter 12px medium
- **Body:** Inter 14px weight 400, color #262626, line-height 1.6
- **Detail:** Optional bold spans for headings within generated text
...
1. **Floating polaroid card:** White (#ffffff) surface, 16px border-radius, drop shadow `rgba(0,0,0,0.1) 0px 10px 15px -3px` and `rgba(0,0,0,0.1) 0px 4px 6px -4px`. Internal image fills the card with 6px image radius. Slight 2–3° rotation. No visible border.

2. **Primary Action Button:** #d7defd background, #000000 text, 9999px radius, compact pill padding. Use this filled treatment for the main CTA.

3. **Hero headline:** Marund weight 500, 96px, line-height 1.0, letter-spacing -4.8px, color #0a0a0a, centered. Below it, a subtitle in Inter 18px weight 400, color #737373, line-height 1.5, max-width 480px, centered.

4. **Workspace canvas card:** White (#ffffff) surface, 12px border-radius, 1px border in #e5e5e5. Header contains a 6px #00c950 status dot + model name in Inter 12px medium #525252. Body image below at 6px radius. An 8px #00c950 node marker sits at the card's right edge for connection point.
